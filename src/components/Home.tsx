...
const Home = () => {
  ...
  return (
    <section className="flex h-screen items-center md:justify-center md:px-16 md:py-16">
      <div className="flex flex-col p-4 md:grid md:grid-cols-3 md:space-x-4 md:rounded-md md:border md:border-sky-500 md:bg-primary/90 md:shadow-2xl">
        <div className="md:col-span-3 md:flex md:flex-col md:justify-center lg:col-span-2">
          <div
            className="text-blue-300"
            dangerouslySetInnerHTML={{ __html: getTMarkdown('home.init') }}
          />
          ...
          <div
            ...
            dangerouslySetInnerHTML={{ __html: getTMarkdown('home.subTitle') }}
          />
          <div
        ...
        <SvgMeditation className="grow object-contain md:col-span-3 md:mx-auto md:my-auto md:w-full md:max-w-xl lg:col-span-1" />
      </div>
      <style jsx>{`
